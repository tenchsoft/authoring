# Spec: control-z-undo-shortcut-control

## 한 줄 정의
사용자가 Story에서 Control Z Undo Shortcut Control을/를 단축키로 수행한다.

## 진입점
- 단축키: Ctrl+Z

## 사용자 흐름
1. From the user's perspective, this keyboard shortcuts control is independent and must not be merged with adjacent controls. When the user activates it by presses Control+Z, the previous StoryEngine undo snapshot restores.
